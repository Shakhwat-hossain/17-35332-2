...
<div class="row">
  <div class="col-3 col-s-3 menu">
   ...
   <li><a href="View/liveSearch.php" style="text-align:center; color: blue; "> <h2>Live Search Products </h2>
 ...
 <div class="col-6 col-s-9">
    ...
    <h1 style="text-align: center; color: blue;"> <?php echo $_SESSION['uname'] ?></h1>
