...
<div class="row">
 ...
 <div class="col-6 col-s-9">
    ...
    <h1 style="text-align: center; color: blue;"> <?php echo $_SESSION['uname'] ?> is adding products</h1><br>
 ...
 <form name="myForm" action="Controller/createProduct.php" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
  ...
  <span id="msg3" style="color: red;"><br>
   </span>

  <input type="file" name="image" class="form-control">
   <span id="msg4" style="color: red;"></span><br><br>

  <input type="submit" name = "createProduct" value="Create" class="form-control"><br>
