...
if (!empty($_SESSION['name'])) {
 ...
 $dobErr = $nameErr = $emailErr = $genderErr =$error=$unameErr="";
...
<form style="border:3px;   padding: 1em;" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
 ...
 <td colspan="2" rowspan="2">
  ...
  <br><br>
  <span style="font-size: 20px;"> <a href="change_password.php">Change Password</a></span><br> <br>
